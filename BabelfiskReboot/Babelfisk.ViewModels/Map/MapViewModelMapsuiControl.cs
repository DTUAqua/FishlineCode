...
{
    public class MapViewModelMapsuiControl: AViewModel, IMapViewModel
    {
        ...
        public MapViewModelMapsuiControl()
        {
            try
            {
        ...
        private void ShowMapInWindow()
        {
            try
            {
                MapViewModelMapsuiControl mvm = new MapViewModelMapsuiControl();
