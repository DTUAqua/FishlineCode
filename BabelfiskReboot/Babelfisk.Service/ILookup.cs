...
namespace Babelfisk.Service
{
    ...
    public interface ILookup
    {
        ...
        [OperationContract]
        DatabaseOperationResult SaveLookups(ref List<ILookupEntity> lstLookups);

        [OperationContract]
        List<Record> GetDependencies(ILookupEntity objLookup);

        [OperationContract]
        List<L_DFUArea> GetRectangleAreas();

        [OperationContract]
        DataVersioning GetLookupVersions();
    }
}
