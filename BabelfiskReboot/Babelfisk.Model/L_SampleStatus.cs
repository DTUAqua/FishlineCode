...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_SampleStatus: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int L_sampleStatusId
        {
            get { return _l_sampleStatusId; }
            set
            {
                if (_l_sampleStatusId != value)
                {
                    _l_sampleStatusId = value;
                    OnPropertyChanged("L_sampleStatusId");
                }
            }
        }
        private int _l_sampleStatusId;
        ...
        public string sampleStatus
        {
            ...
            set
            {
                if (_sampleStatus != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'sampleStatus' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _sampleStatus = value;
        ...
        private void FixupSample(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_SampleStatus, this))
                    {
                        item.L_SampleStatus = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
