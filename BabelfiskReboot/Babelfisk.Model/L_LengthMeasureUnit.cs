...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_LengthMeasureUnit: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int L_lengthMeasureUnitId
        {
            get { return _l_lengthMeasureUnitId; }
            set
            {
                if (_l_lengthMeasureUnitId != value)
                {
                    _l_lengthMeasureUnitId = value;
                    OnPropertyChanged("L_lengthMeasureUnitId");
                }
            }
        }
        private int _l_lengthMeasureUnitId;
        ...
        public string lengthMeasureUnit
        {
            ...
            set
            {
                if (_lengthMeasureUnit != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'lengthMeasureUnit' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupAnimal(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_LengthMeasureUnit, this))
                    {
                        item.L_LengthMeasureUnit = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
