...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_SamplingType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int samplingTypeId
        {
            ...
            set
            {
                if (_samplingTypeId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'samplingTypeId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupTrip(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_SamplingType, this))
                    {
                        item.L_SamplingType = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
