...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_GearInfoType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int L_gearInfoTypeId
        {
            get { return _l_gearInfoTypeId; }
            set
            {
                if (_l_gearInfoTypeId != value)
                {
                    _l_gearInfoTypeId = value;
                    OnPropertyChanged("L_gearInfoTypeId");
                }
            }
        }
        private int _l_gearInfoTypeId;
        ...
        public string gearInfoType
        {
            ...
            set
            {
                if (_gearInfoType != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'gearInfoType' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _gearInfoType = value;
        ...
        [DataMember]
        public string dfuBase_dfuref
        {
            get { return _dfuBase_dfuref; }
            set
            {
                if (_dfuBase_dfuref != value)
                {
                    _dfuBase_dfuref = value;
                    OnPropertyChanged("dfuBase_dfuref");
                }
            }
        }
        private string _dfuBase_dfuref;
        ...
        private void FixupR_GearInfo(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_GearInfoType, this))
                    {
                        item.L_GearInfoType = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
