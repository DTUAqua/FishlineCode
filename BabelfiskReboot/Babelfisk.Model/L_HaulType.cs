...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_HaulType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int L_haulTypeId
        {
            get { return _l_haulTypeId; }
            set
            {
                if (_l_haulTypeId != value)
                {
                    _l_haulTypeId = value;
                    OnPropertyChanged("L_haulTypeId");
                }
            }
        }
        private int _l_haulTypeId;
        ...
        public string haulType
        {
            ...
            set
            {
                if (_haulType != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'haulType' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _haulType = value;
        ...
        private void FixupSample(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_HaulType, this))
                    {
                        item.L_HaulType = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
