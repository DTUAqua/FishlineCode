...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_PlatformType: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int L_platformTypeId
        {
            get { return _l_platformTypeId; }
            set
            {
                if (_l_platformTypeId != value)
                {
                    _l_platformTypeId = value;
                    OnPropertyChanged("L_platformTypeId");
                }
            }
        }
        private int _l_platformTypeId;
        ...
        public string platformType
        {
            ...
            set
            {
                if (_platformType != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'platformType' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _platformType = value;
        ...
        private void FixupL_Platform(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_PlatformType, this))
                    {
                        item.L_PlatformType = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
