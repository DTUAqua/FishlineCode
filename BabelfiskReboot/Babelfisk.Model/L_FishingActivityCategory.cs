...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_FishingActivityCategory: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupSample(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                ...
                {
                    item.L_FishingActivityCategory = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_FishingActivityCategory, this))
                    {
                        item.L_FishingActivityCategory = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
