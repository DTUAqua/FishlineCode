...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_CruiseStatus: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int L_cruiseStatusId
        {
            get { return _l_cruiseStatusId; }
            set
            {
                if (_l_cruiseStatusId != value)
                {
                    _l_cruiseStatusId = value;
                    OnPropertyChanged("L_cruiseStatusId");
                }
            }
        }
        private int _l_cruiseStatusId;
        ...
        public string cruiseStatus
        {
            ...
            set
            {
                if (_cruiseStatus != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'cruiseStatus' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _cruiseStatus = value;
        ...
        private void FixupCruise(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_CruiseStatus, this))
                    {
                        item.L_CruiseStatus = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
