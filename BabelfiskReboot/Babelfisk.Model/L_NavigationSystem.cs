...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_NavigationSystem: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int L_navigationSystemId
        {
            get { return _l_navigationSystemId; }
            set
            {
                if (_l_navigationSystemId != value)
                {
                    _l_navigationSystemId = value;
                    OnPropertyChanged("L_navigationSystemId");
                }
            }
        }
        private int _l_navigationSystemId;
        ...
        public string navigationSystem
        {
            ...
            set
            {
                if (_navigationSystem != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'navigationSystem' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupL_PlatformVersion(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_NavigationSystem, this))
                    {
                        item.L_NavigationSystem = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
