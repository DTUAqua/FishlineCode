...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_ThermoCline: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int L_thermoClineId
        {
            get { return _l_thermoClineId; }
            set
            {
                if (_l_thermoClineId != value)
                {
                    _l_thermoClineId = value;
                    OnPropertyChanged("L_thermoClineId");
                }
            }
        }
        private int _l_thermoClineId;
        ...
        public string thermoCline
        {
            ...
            set
            {
                if (_thermoCline != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'thermoCline' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _thermoCline = value;
        ...
        private void FixupSample(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_ThermoCline, this))
                    {
                        item.L_ThermoCline = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
