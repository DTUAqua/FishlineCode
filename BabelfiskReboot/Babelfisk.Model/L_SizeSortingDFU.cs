...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_SizeSortingDFU: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int L_sizeSortingDFUId
        {
            get { return _l_sizeSortingDFUId; }
            set
            {
                if (_l_sizeSortingDFUId != value)
                {
                    _l_sizeSortingDFUId = value;
                    OnPropertyChanged("L_sizeSortingDFUId");
                }
            }
        }
        private int _l_sizeSortingDFUId;
        ...
        public string sizeSortingDFU
        {
            ...
            set
            {
                if (_sizeSortingDFU != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'sizeSortingDFU' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupSpeciesList(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_SizeSortingDFU, this))
                    {
                        item.L_SizeSortingDFU = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
