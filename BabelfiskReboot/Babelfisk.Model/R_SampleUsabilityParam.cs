...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class R_SampleUsabilityParam: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public int R_SampleUsabilityParamId
        {
            get { return _r_SampleUsabilityParamId; }
            set
            {
                if (_r_SampleUsabilityParamId != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'R_SampleUsabilityParamId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _r_SampleUsabilityParamId = value;
                    OnPropertyChanged("R_SampleUsabilityParamId");
                }
            }
        }
        private int _r_SampleUsabilityParamId;
            ...
            set
            {
                if (!ReferenceEquals(_l_UsabilityParam, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added && value != null)
                    {
                        ...
                        if (usabilityParamId != value.usabilityParamId)
                        {
        ...
        private void FixupL_UsabilityParam(L_UsabilityParam previousValue)
        {
            ...
            if (previousValue != null && previousValue.R_SampleUsabilityParam.Contains(this))
            {
                previousValue.R_SampleUsabilityParam.Remove(this);
            }
    
            if (L_UsabilityParam != null)
            {
                if (!L_UsabilityParam.R_SampleUsabilityParam.Contains(this))
                {
                    L_UsabilityParam.R_SampleUsabilityParam.Add(this);
                }
        ...
        private void FixupSample(Sample previousValue)
        {
            ...
            if (Sample != null)
            {
                if (!Sample.R_SampleUsabilityParam.Contains(this))
                {
                    Sample.R_SampleUsabilityParam.Add(this);
                }
