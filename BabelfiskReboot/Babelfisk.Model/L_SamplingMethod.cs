...
namespace Babelfisk.Entities.Sprattus
{
    ...
    public partial class L_SamplingMethod: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int samplingMethodId
        {
            ...
            set
            {
                if (_samplingMethodId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'samplingMethodId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
        ...
        private void FixupTrip(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.L_SamplingMethod, this))
                    {
                        item.L_SamplingMethod = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
