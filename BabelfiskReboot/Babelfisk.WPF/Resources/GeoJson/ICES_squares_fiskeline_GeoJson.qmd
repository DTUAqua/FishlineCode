...
<qgis version="3.44.2-Solothurn">
  <identifier>ices_squares</identifier>
  <parentidentifier></parentidentifier>
  <language>DA</language>
  <type>dataset</type>
  <title>ices_squares</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" format="" type="Local Area Network" mimeType="" description="" name="Shapefile" url="file://\\dfu.local\arkiv\gis\GEOdata\BasicLayers\Boundaries\Ices\ices_squares.shp"/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial crs="EPSG:4326" maxy="85" minx="-44" maxz="0" dimensions="2" minz="0" maxx="69" miny="36"/>
  </extent>
</qgis>
